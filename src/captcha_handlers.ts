...
import type { CaptchaHandler } from './webvpn.js'

export async function ask_from_command_line(message = "What's the captcha? (case-insensitive)"): Promise<string> {
 ...
 * @returns
 */
export function display_captcha_then_ask_from_command_line(
  options: {
